...
<body>
    ...
    <div class="left" style="padding-left: 20px; margin-left: 220px;">
        <div style="font-family: Arial, sans-serif; margin: 0; padding: 0;">
            <div style="max-width: 1000px; margin: 20px auto; padding: 20px; background-color: #EFE9D3; border-radius: 5px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
                <h1 style="text-align: center; font-family: 'Playfair Display'; margin-bottom: 20px;">Kelola Menu</h1>
                <div style="margin-bottom: 20px;">
                    <div class="search" style="display:flex; align-items: center;">
                        <div class="search-box" style="align-items: center; border: 1px solid #cfbcae; border-radius: 5px; padding: 5px; width: 500px; height: 40px;">
                    ...
                    <button onclick="openAdd()" style="background-color: #4CAF50; color: white; float:right; margin-bottom:10px; padding: 5px 10px; font-size:10px; border: none; border-radius: 5px; cursor: pointer; margin-top: 20px;  display:flex;">Tambah Menu</button>
                    <h2 style="margin-top: 50px; font-family: 'Playfair Display';">Makanan</h2>
                ...
                <table style="width: 100%; border-collapse: collapse; margin-top: 20px; background-color: #ffffff; border-radius:15px;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px; border-bottom: 1px solid #ddd;">
                            <button onclick="openEdit()" style="background-color: #4CAF50; color: white; padding: 5px 10px; font-size:10px; border: none; border-radius: 5px; cursor: pointer; margin-top: 20px;">Edit</button>
                            <button style="background-color: #f44336; color: white; padding: 5px 10px; font-size:10px; border: none; border-radius: 3px; cursor: pointer;">Hapus</button>
                        </td>
                    </tr>
